...
$sel_operday = mysqli_query($link, "SELECT * FROM `operatorwd` WHERE `idoper` = '$idus' AND `end` = 0");
$sel_operday = mysqli_fetch_assoc($sel_operday);

$sel_driverday = mysqli_query($link, "SELECT * FROM `driverwd` WHERE `iddriver` = '$idus' AND `end` = 0");
